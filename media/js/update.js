...
this.op=op||{};
//options
this.op.l = op.l||n["language"]||n["userLanguage"]||document.documentElement.getAttribute("lang")||"ru";
var ll=this.op.l.substr(0,2);
this.op.vsakt = {i:11,f:28,o:22,s:7,n:20,c:32};
...
var myvs=op.vs||{};
this.op.vs =op.vs||this.op.vsakt;
