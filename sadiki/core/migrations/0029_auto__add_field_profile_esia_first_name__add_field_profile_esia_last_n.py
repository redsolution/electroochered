...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.esia_first_name'
        db.add_column('core_profile', 'esia_first_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.esia_last_name'
        db.add_column('core_profile', 'esia_last_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.esia_email'
        db.add_column('core_profile', 'esia_email',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.esia_phone_number'
        db.add_column('core_profile', 'esia_phone_number',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.esia_first_name'
        db.delete_column('core_profile', 'esia_first_name')

        # Deleting field 'Profile.esia_last_name'
        db.delete_column('core_profile', 'esia_last_name')

        # Deleting field 'Profile.esia_email'
        db.delete_column('core_profile', 'esia_email')

        # Deleting field 'Profile.esia_phone_number'
        db.delete_column('core_profile', 'esia_phone_number')
    ...
    models = {
        ...
        'core.benefitcategory': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'priority': ('django.db.models.fields.PositiveIntegerField', [], {'unique': 'True'})
        },
        'core.distribution': {
            'Meta': {'ordering': "['end_datetime']", 'object_name': 'Distribution'},
        ...
        'core.profile': {
            ...
            'esia_email': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'esia_first_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'esia_id': ('django.db.models.fields.CharField', [], {'max_length': '63', 'null': 'True', 'blank': 'True'}),
            'esia_last_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'esia_phone_number': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        'core.requestion': {
            ...
            'previous_status': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
