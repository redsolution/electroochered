...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Requestion.district'
        db.add_column('core_requestion', 'district',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.District'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Area.district'
        db.add_column('core_area', 'district',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.District'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Requestion.district'
        db.delete_column('core_requestion', 'district_id')

        # Deleting field 'Area.district'
        db.delete_column('core_area', 'district_id')
