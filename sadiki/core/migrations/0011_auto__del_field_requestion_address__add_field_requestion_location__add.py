...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Requestion.address'
        db.delete_column('core_requestion', 'address_id')

        # Adding field 'Requestion.location'
        db.add_column('core_requestion', 'location',
                      self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Requestion.location_properties'
        db.add_column('core_requestion', 'location_properties',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Requestion.address'
        db.add_column('core_requestion', 'address',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Address'], null=True),
                      keep_default=False)

        # Deleting field 'Requestion.location'
        db.delete_column('core_requestion', 'location')

        # Deleting field 'Requestion.location_properties'
        db.delete_column('core_requestion', 'location_properties')
