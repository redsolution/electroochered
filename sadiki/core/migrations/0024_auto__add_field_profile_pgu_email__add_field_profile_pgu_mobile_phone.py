...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.pgu_email'
        db.add_column('core_profile', 'pgu_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True),
                      keep_default=False)

        # Adding field 'Profile.pgu_mobile_phone'
        db.add_column('core_profile', 'pgu_mobile_phone',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.pgu_email'
        db.delete_column('core_profile', 'pgu_email')

        # Deleting field 'Profile.pgu_mobile_phone'
        db.delete_column('core_profile', 'pgu_mobile_phone')
    ...
    models = {
        ...
        'core.profile': {
            ...
            'pgu_email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True'}),
            'pgu_mobile_phone': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
