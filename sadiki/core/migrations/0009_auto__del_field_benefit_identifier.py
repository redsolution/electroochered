...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Benefit.identifier'
        db.delete_column('core_benefit', 'identifier')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Benefit.identifier'
        raise RuntimeError("Cannot reverse this migration. 'Benefit.identifier' and its values cannot be restored.")
