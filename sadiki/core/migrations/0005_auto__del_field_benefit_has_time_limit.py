...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Benefit.has_time_limit'
        db.delete_column('core_benefit', 'has_time_limit')


    def backwards(self, orm):
        # Adding field 'Benefit.has_time_limit'
        db.add_column('core_benefit', 'has_time_limit',
