...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.social_auth_public'
        db.alter_column('core_profile', 'social_auth_public', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Profile.social_auth_public'
        db.alter_column('core_profile', 'social_auth_public', self.gf('django.db.models.fields.BooleanField')())
