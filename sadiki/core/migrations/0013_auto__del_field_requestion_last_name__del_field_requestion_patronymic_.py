...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Requestion.last_name'
        db.delete_column('core_requestion', 'last_name')

        # Deleting field 'Requestion.patronymic'
        db.delete_column('core_requestion', 'patronymic')

        # Deleting field 'Requestion.first_name'
        db.delete_column('core_requestion', 'first_name')

        # Deleting field 'Requestion.agent_type'
        db.delete_column('core_requestion', 'agent_type')

        # Adding field 'Requestion.name'
        db.add_column('core_requestion', 'name',
        ...
        db.delete_column('core_profile', 'patronymic')

        # Deleting field 'Profile.first_name'
        db.delete_column('core_profile', 'first_name')

        # Adding field 'Profile.nickname'
        db.add_column('core_profile', 'nickname',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Requestion.last_name'
        db.add_column('core_requestion', 'last_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Requestion.patronymic'
        db.add_column('core_requestion', 'patronymic',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Requestion.first_name'
        db.add_column('core_requestion', 'first_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Requestion.agent_type'
        raise RuntimeError("Cannot reverse this migration. 'Requestion.agent_type' and its values cannot be restored.")
        # Deleting field 'Requestion.name'
        db.delete_column('core_requestion', 'name')
        ...
        db.add_column('core_profile', 'patronymic',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)
        ...
        db.delete_column('core_profile', 'nickname')
    ...
    models = {
        ...
        'core.profile': {
            ...
            'nickname': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
