...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Requestion.distribution_type'
        db.add_column('core_requestion', 'distribution_type',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Requestion.previous_distributed_in_vacancy'
        db.add_column('core_requestion', 'previous_distributed_in_vacancy',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'previous_requestions', null=True, to=orm['core.Vacancies']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Requestion.distribution_type'
        db.delete_column('core_requestion', 'distribution_type')

        # Deleting field 'Requestion.previous_distributed_in_vacancy'
        db.delete_column('core_requestion', 'previous_distributed_in_vacancy_id')
