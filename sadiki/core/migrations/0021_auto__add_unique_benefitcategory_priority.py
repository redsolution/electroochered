...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'BenefitCategory', fields ['priority']
        db.create_unique('core_benefitcategory', ['priority'])


    def backwards(self, orm):
        # Removing unique constraint on 'BenefitCategory', fields ['priority']
        db.delete_unique('core_benefitcategory', ['priority'])
