...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EvidienceDocument.fake'
        db.add_column('core_evidiencedocument', 'fake',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EvidienceDocument.fake'
        db.delete_column('core_evidiencedocument', 'fake')
