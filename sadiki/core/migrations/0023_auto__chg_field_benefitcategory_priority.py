...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BenefitCategory.priority'
        db.alter_column('core_benefitcategory', 'priority', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True))

    def backwards(self, orm):

        # Changing field 'BenefitCategory.priority'
        db.alter_column('core_benefitcategory', 'priority', self.gf('django.db.models.fields.IntegerField')(unique=True))
