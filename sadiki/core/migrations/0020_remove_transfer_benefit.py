...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm['core.BenefitCategory'].objects.filter(name=u"Внеочередной перевод", priority=100).delete()

    def backwards(self, orm):
        "Write your backwards methods here."
        orm['core.BenefitCategory'].objects.create(name=u"Внеочередной перевод", priority=100)
