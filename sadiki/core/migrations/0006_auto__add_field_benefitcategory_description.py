...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BenefitCategory.description'
        db.add_column('core_benefitcategory', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BenefitCategory.description'
        db.delete_column('core_benefitcategory', 'description')
