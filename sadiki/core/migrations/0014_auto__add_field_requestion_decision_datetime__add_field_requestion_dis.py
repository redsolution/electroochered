...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Requestion.decision_datetime'
        db.add_column('core_requestion', 'decision_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Requestion.distribution_datetime'
        db.add_column('core_requestion', 'distribution_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Requestion.decision_datetime'
        db.delete_column('core_requestion', 'decision_datetime')

        # Deleting field 'Requestion.distribution_datetime'
        db.delete_column('core_requestion', 'distribution_datetime')
