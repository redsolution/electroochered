...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EvidienceDocumentTemplate.import_involved'
        db.add_column('core_evidiencedocumenttemplate', 'import_involved',
        ...
        # Adding unique constraint on 'Benefit', fields ['name']
        db.create_unique('core_benefit', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Benefit', fields ['name']
        db.delete_unique('core_benefit', ['name'])
