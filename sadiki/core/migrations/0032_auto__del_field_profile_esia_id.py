...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.esia_id'
        db.delete_column('core_profile', 'esia_id')


    def backwards(self, orm):
        # Adding field 'Profile.esia_id'
        db.add_column('core_profile', 'esia_id',
                      self.gf('django.db.models.fields.CharField')(unique=True, max_length=63, null=True),
                      keep_default=False)
