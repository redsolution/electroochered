...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Profile', fields ['esia_id']
        db.create_unique('core_profile', ['esia_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Profile', fields ['esia_id']
        db.delete_unique('core_profile', ['esia_id'])
    ...
    models = {
        ...
        'core.profile': {
            ...
            'esia_id': ('django.db.models.fields.CharField', [], {'max_length': '63', 'unique': 'True', 'null': 'True'}),
