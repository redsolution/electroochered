...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Area.address'
        db.delete_column('core_area', 'address_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Area.address'
        raise RuntimeError("Cannot reverse this migration. 'Area.address' and its values cannot be restored.")
