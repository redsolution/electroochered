...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Requestion.previous_status'
        db.add_column('core_requestion', 'previous_status',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Requestion.previous_status'
        db.delete_column('core_requestion', 'previous_status')
