...
EO_PRIVATE_KEY = config.get('esia', 'EO_PRIVATE_KEY').decode('string-escape')
EO_CERTIFICATE = config.get('esia', 'EO_CERTIFICATE').decode('string-escape')
ESIA_CERTIFICATE = config.get('esia', 'ESIA_CERTIFICATE').decode('string-escape')
