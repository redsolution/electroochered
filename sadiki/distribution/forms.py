...
from sadiki.core.models import REQUESTION_TYPE_IMPORTED, REQUESTION_TYPE_GOSUSLUGI
...
class SelectSadikForm(forms.Form):
    ...
    def __init__(self, requestion, *args, **kwargs):
        ...
        if requestion.cast in (REQUESTION_TYPE_IMPORTED, REQUESTION_TYPE_GOSUSLUGI):
