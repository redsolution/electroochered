...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Logger.profile'
        db.add_column('logger_logger', 'profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Profile'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Logger.profile'
        db.delete_column('logger_logger', 'profile_id')
